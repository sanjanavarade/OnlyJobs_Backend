...
const { getProfile, updateProfile, uploadResume, matchResume } = require('../controllers/userController');
...
router.post('/resume/match', standard, authenticate, requireRole('job_seeker'), matchResume);
