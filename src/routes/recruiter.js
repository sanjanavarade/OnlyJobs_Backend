...
const { getApplicants, getMyApplicants, updateStatus, scheduleInterview, getMe, getMyJobs } = require('../controllers/recruiterController');
const { authenticate, requireRole } = require('../middlewares/auth');
const { standard, strict } = require('../middlewares/rateLimiter');

router.get('/me',                      standard, authenticate, requireRole('recruiter'), getMe);
router.get('/jobs',                    standard, authenticate, requireRole('recruiter'), getMyJobs);
